          ...
          <el-form-item class="input" label="学员账号" prop="xueyuanzhanghao">
              <el-input v-model="ruleForm.xueyuanzhanghao" 
                placeholder="学员账号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约科目" prop="yuyuekemu">
          <el-input v-model="ruleForm.yuyuekemu" 
              placeholder="预约科目" clearable  :readonly="ro.yuyuekemu"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="预约时间" prop="yuyueshijian">
              <el-input v-model="ruleForm.yuyueshijian" 
                placeholder="预约时间" readonly></el-input>
                                                                                                            ...
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="取消理由" prop="quxiaoliyou">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.quxiaoliyou" label="取消理由" prop="quxiaoliyou">
                    <span>{{ruleForm.quxiaoliyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
