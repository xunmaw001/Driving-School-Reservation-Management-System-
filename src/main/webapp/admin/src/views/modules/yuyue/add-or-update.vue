    ...
    >
      <el-row>
        ...
        <el-form-item class="select" v-if="type!='info'"  label="预约科目" prop="yuyuekemu">
          <el-select v-model="ruleForm.yuyuekemu" placeholder="请选择预约科目">
            <el-option
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.yuyuekemu"
                placeholder="预约科目" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="预约车牌" prop="yuyuechepai">
          <el-select v-model="ruleForm.yuyuechepai" placeholder="请选择预约车牌">
            <el-option
                v-for="(item,index) in yuyuechepaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="预约车牌" prop="yuyuechepai">
	      <el-input v-model="ruleForm.yuyuechepai"
                placeholder="预约车牌" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuyuekemu = true;
            continue;
	            	            ...
	            	            if(o=='yuyuechepai'){
            this.ruleForm.yuyuechepai = obj[o];
	    this.ro.yuyuechepai = true;
            continue;
          }
	            	            if(o=='yuyueshijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                    ...
                                                                                                                                    this.yuyuekemuOptions = "科目一,科目二,科目三,科目四".split(',')
                                        this.$http({
              url: `option/jiaxiaocheliang/chepaihao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.yuyuechepaiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
